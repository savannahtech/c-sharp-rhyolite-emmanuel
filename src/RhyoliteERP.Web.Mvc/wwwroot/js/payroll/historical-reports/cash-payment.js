...
var vue = new Vue({
    ...
    data: {
        ...
        reportPathConfig: {
            ...
            summaryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682322825/reportapi/payroll/cash-payment-summary.rdl',
            categoryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682322825/reportapi/payroll/cash-payment-by-category.rdl',
            departmentReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682322825/reportapi/payroll/cash-payment-by-department.rdl',
        },
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = `/PayrollReports/HrGetCashPayments?month=${this.month}&year=${this.year}`;
            ...
            switch (this.reportType) {
                ...
                default:
                    this.reportPath = this.reportPathConfig.summaryReportPath;
                    url = `/PayrollReports/HrGetCashPayments?month=${this.month}&year=${this.year}`;
