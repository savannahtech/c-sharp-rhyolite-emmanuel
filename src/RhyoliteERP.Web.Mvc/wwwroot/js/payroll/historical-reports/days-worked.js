...
var vue = new Vue({
    ...
    data: {
        ...
        reportPathConfig: {
            ...
            summaryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682324149/reportapi/payroll/days-worked-summary.rdl',
            categoryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682324149/reportapi/payroll/days-worked-by-category.rdl',
            departmentReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682324149/reportapi/payroll/days-worked-by-department.rdl',
        },
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = `/PayrollReports/HrGetDaysWorked?month=${this.month}&year=${this.year}`;
            ...
            switch (this.reportType) {
                ...
                default:
                    ...
                    url = `/PayrollReports/HrGetDaysWorked?month=${this.month}&year=${this.year}`;
