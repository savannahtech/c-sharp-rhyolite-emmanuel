...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = `/PayrollReports/HrGetDeductions?month=${this.month}&year=${this.year}`;
            ...
            switch (this.reportType) {
                ...
                case 'deduction-type':
                    ...
                    url = `/PayrollReports/HrGetDeductionsByType?deductionTypeId=${this.deductionTypeId}&month=${this.month}&year=${this.year}`;
                ...
                default:
                    this.reportPath = this.reportPathConfig.summaryReportPath;
                    url = `/PayrollReports/HrGetDeductions?month=${this.month}&year=${this.year}`;
