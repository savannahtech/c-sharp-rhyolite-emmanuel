...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            axios.get(`/PayrollReports/HrGetPayeeReturns?month=${this.month}&year=${this.year}`).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1683744186/reportapi/payroll/payee-returns.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
