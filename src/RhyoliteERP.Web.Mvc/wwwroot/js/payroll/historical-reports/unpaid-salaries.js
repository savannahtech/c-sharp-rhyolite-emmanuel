...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            axios.get(`/PayrollReports/HrGetPayRegister?month=${this.month}&year=${this.year}`).then(response => {

                response.data.reportHeader.forEach((v) => {

                    v.reportTitle = `Unpaid Salaries: ${response.data.reportDetails.currentDate}`;
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682264206/reportapi/payroll/unpaid-salaries.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
