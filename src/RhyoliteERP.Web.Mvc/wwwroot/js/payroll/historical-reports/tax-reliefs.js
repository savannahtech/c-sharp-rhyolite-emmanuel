...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            axios.get(`/PayrollReports/HrGetTaxReliefs?month=${this.month}&year=${this.year}`).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682325831/reportapi/payroll/tax-relief.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
