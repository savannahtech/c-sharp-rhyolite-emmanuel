...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            axios.get(`/PayrollReports/HrGetPensionScheme?schemeType=${this.reportType}&month=${this.month}&year=${this.year}`).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682950879/reportapi/payroll/pension-scheme.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
