...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            axios.get(`/PayrollReports/HrGetSalaryAdvance?month=${this.month}&year=${this.year}`).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682267912/reportapi/payroll/salary-advance.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
