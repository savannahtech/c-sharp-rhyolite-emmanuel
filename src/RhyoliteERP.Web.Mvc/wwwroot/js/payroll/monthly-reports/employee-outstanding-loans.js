...
var vue = new Vue({
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = '/PayrollReports/GetOutstandingLoans';
            ...
            switch (this.reportType) {
                ...
                case 'loan-type':
                    ...
                    url = `/PayrollReports/GetOutstandingLoansByLoanType?loanTypeId=${this.loanTypeId}`;
                ...
                case 'employee':
                    ...
                    url = `/PayrollReports/GetOutstandingLoansByLoanType?employeeId=${this.employeeId}&loanTypeId=${this.loanTypeId}`;
                ...
                default:
                    ...
                    url = '/PayrollReports/GetOutstandingLoans';
