...
var vue = new Vue({
    ...
    data: {
        ...
        reportPathConfig: {
            ...
            summaryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682321393/reportapi/payroll/bank-payment-by-category.rdl',
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = '/PayrollReports/GetBankPayments';
            ...
            switch (this.reportType) {
                ...
                case 'bank':
                    ...
                    url = `/PayrollReports/GetBankPaymentsByBank?bankId=${this.bankId}`;

                    break;

                default:
                    this.reportPath = this.reportPathConfig.summaryReportPath;
                    url = '/PayrollReports/GetBankPayments';
