...
var vue = new Vue({
    ...
    data: {
        ...
        reportPathConfig: {
            ...
            summaryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682263316/reportapi/payroll/pay-register-summary.rdl',
            categoryReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682263316/reportapi/payroll/pay-register-by-category.rdl',
            departmentReportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1682263317/reportapi/payroll/pay-register-by-department.rdl',
        },
    ...
    methods: {
        ...
        getReportData() {
            ...
            let url = '/PayrollReports/GetPayRegister';
            ...
            switch (this.reportType) {
                ...
                default:
                    this.reportPath = this.reportPathConfig.summaryReportPath;
                    url = '/PayrollReports/GetPayRegister';
