    ...
    methods: {
        ...
        getData() {
            ...
            if (this.startDate && this.endDate) {
                ...
                axios.get('/RentalMessaging/GetMessages?startDate=' + this.startDate + '&endDate=' + this.endDate).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1666723393/reportapi/sm/BusinessSmsReport.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
