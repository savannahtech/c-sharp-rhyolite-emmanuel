    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId && this.selectedBillTypeId) {
                ...
                axios.get('/SchEnquiries/GetCancelledBills?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId + '&billTypeId=' + this.selectedBillTypeId).then(response => {
                    ...
                    this.toastHandler('error', 'Unable to get cancelled bills');
        ...
        renderTable(responseData1) {
            ...
            $("#dataTable").ejGrid({
                ...
                columns: [
                    ...
                    { field: "billDate", headerText: 'Bill Date', textAlign: ej.TextAlign.Left, width: 65 },
                    { field: "billAmount", headerText: 'Bill Amount', format: "{0:n2}", textAlign: ej.TextAlign.Right, width: 55 },
                    { field: "billBalance", headerText: 'Bill Balance', format: "{0:n2}", textAlign: ej.TextAlign.Right, width: 55 },
