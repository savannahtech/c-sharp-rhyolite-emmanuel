    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId) {
                ...
                axios.get('/SchEnquiries/GetPaidUpStudents?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId ).then(response => {
