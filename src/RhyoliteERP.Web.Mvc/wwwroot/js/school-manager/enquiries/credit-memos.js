    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId) {
                ...
                axios.get('/SchEnquiries/GetCreditMemos?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId ).then(response => {
        ...
        renderTable(responseData) {
            ...
            $("#dataTable").ejGrid({
                ...
                columns: [
                    ...
                    { field: "acaYrId", visible: false, width: 10, },
