    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId) {
                ...
                axios.get('/SchReports/GetAttendanceSummary?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1634342936/reportapi/sm/AttendanceSummary.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
