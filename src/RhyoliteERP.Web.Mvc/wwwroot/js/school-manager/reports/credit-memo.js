    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId) {
                ...
                axios.get('/SchReports/GetCreditMemos?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1634735746/reportapi/sm/CreditMemo.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
