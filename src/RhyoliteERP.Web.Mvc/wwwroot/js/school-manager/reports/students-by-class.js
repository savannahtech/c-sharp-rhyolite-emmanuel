    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedClassId) {
                ...
                axios.get('/SchReports/GetStudentsByClass?classId=' + this.selectedClassId).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1634342936/reportapi/sm/StudentsByClass.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
