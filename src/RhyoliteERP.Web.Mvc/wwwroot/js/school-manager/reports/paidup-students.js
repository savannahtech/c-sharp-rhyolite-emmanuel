    ...
    methods: {
        ...
        getData() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId) {
                ...
                axios.get('/SchReports/GetPaidUpStudents?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId).then(response => {
        ...
        renderReport(header, details) {
            ...
            $("#reportView").boldReportViewer({
                ...
                reportPath: 'https://res.cloudinary.com/rhyoliteprime/raw/upload/v1634520789/reportapi/sm/PaidupStudents.rdl',
                dataSources: [{
                    value: header,
                    name: "DataSet1"
                },
