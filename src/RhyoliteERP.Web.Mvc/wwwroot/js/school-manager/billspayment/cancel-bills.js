    ...
    methods: {
        ...
        getBills() {
            ...
            if (this.selectedAcademicYearId && this.selectedTermId && this.selectedClassId && this.selectedBillTypeId) {
                ...
                axios.get('/BillsAndPayments/GetBillsToCancel?academicYearId=' + this.selectedAcademicYearId + '&termId=' + this.selectedTermId + '&classId=' + this.selectedClassId + '&billTypeId=' + this.selectedBillTypeId).then(response => {
        ...
        cancelBills() {
            ...
            if (this.studentBills.length) {
                ...
                axios.post('/BillsAndPayments/CancelStudentBills', this.studentBills).then(response => {
                    ...
                    this.toastHandler('', 'Bill(s) cancelled successfully.');
                    this.getBills();

                }).catch(err => {

                    this.toastHandler('error', 'Unable to cancel bills.');
                    this.isLoading = false;
