    ...
    methods: {
        ...
        downloadFile() {
            ...
            if (this.classId) {
                ...
                window.location.href = `/SchImportData/DownloadOpeningBalancesUploadSample?classId=${this.classId}`;

            }
            else {
                window.location.href = '/SchImportData/DownloadOpeningBalancesUploadSample';
