...
{
   public class SchoolProfile : Abp.Domain.Entities.Auditing.FullAuditedEntity<Guid>, Abp.Domain.Entities.IMustHaveTenant
    {
        //school profile..
        ...
        //report templates
        public string BillTemplateFileUrl { get; set; }
        public string TerminalReportTemplateFileUrl { get; set; }
