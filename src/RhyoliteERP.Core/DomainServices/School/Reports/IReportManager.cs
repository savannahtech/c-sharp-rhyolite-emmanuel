   ...
   public interface IReportManager : Abp.Domain.Services.IDomainService
    {
        ...
        Task<object> FindStudentBillByTenant(Guid academicYearId, Guid termId, Guid classId, Guid studentId, int tenantId);
        ...
        Task<IEnumerable<object>> GetResultUploads(Guid academicYearId, Guid termId, Guid classId, int tenantId);
        Task<IEnumerable<object>> GetStudsByClass(Guid classId, int tenantId);
