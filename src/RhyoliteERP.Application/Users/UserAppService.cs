...
using RhyoliteERP.Authorization.Accounts;
...
namespace RhyoliteERP.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        public async Task<object> ListAll(int pageNo, int pageSize)
        {
            ...
            var data = await _userManager.Users.Skip((pageNo - 1) * pageSize).Take(pageSize).Select(a => new { a.Id, a.IsActive, a.FullName, a.Name, a.Surname, a.UserName, a.EmailAddress, a.Roles, a.TenantId, CreationTime = a.CreationTime.ToString("dd-MMM-yyyy hh:mm:ss tt"), }).ToListAsync();
